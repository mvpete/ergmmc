/**
 * Shared token exchange logic for dev server (ES Module)
 */

export async function exchangeToken(fetch, { code, refresh_token, grant_type = 'authorization_code', clientId, clientSecret, redirectUri }) {
